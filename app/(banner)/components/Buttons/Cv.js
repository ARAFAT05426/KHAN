...
const Cv = () => {
  return (
    <a className="flex justify-center" href="/me.png" download={true}>
      <button className="bg-card text-center w-48 tablet:w-52 rounded-full h-12 tablet:h-14 relative text-primary text-sm tablet:text-lg font-semibold group z-10">
